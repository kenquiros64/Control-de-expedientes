...
describe "EliminarPacientesSpec" do
  ...
  it "test_eliminar_pacientes_spec" do
    ...
    @driver.find_element(:link, "Eliminar").click
    close_alert_and_get_its_text().should =~ /^Desea continuar[\s\S]$/
    (@driver.find_element(:id, "notice").text).should == "Paciente fue eliminado exitosamente."
  end
