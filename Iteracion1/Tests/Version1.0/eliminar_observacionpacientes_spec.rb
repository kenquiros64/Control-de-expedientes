...
describe "EliminarObservacionpacientesSpec" do
  ...
  it "test_eliminar_observacionpacientes_spec" do
    ...
    (@driver.find_element(:id, "notice").text).should == "Observación fue eliminada exitosamente."
  end
