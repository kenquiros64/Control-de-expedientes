...
describe "EditarObservacionpacientesSpec" do
  ...
  it "test_editar_observacionpacientes_spec" do
    ...
    @driver.find_element(:id, "observacion_descripcion").send_keys "Observación cambio"
    @driver.find_element(:name, "commit").click
    (@driver.find_element(:id, "notice").text).should == "Observación fue actualizada exitosamente."
  end
