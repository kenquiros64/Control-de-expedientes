...
describe "AgregarObservacionpacientesSpec" do
  ...
  it "test_agregar_observacionpacientes_spec" do
    ...
    @driver.find_element(:id, "observacion_descripcion").send_keys "Observación"
    @driver.find_element(:name, "commit").click
