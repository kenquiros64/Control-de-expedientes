...
describe "EditarEnfermedadesSpec" do
  ...
  it "test_editar_enfermedades_spec" do
    ...
    @driver.find_element(:id, "enfermedad_descripcion").send_keys "Cáncer de piel"
    @driver.find_element(:name, "commit").click
    (@driver.find_element(:id, "notice").text).should == "Enfermedad fue actualizada exitosamente."
  end
