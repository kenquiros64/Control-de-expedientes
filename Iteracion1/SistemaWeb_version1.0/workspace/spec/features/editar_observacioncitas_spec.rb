...
describe "EditarObservacioncitasSpec" do
  ...
  it "test_editar_observacioncitas_spec" do
    ...
    @driver.find_element(:id, "observacion_descripcion").send_keys "Observación cita cambio"
    @driver.find_element(:name, "commit").click
