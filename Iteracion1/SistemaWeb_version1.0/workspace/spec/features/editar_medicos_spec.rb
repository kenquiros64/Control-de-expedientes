...
describe "EditarMedicosSpec" do
  ...
  it "test_editar_medicos_spec" do
    @driver.get(@base_url + "/medicos/sign_in")
    @driver.find_element(:id, "medico_email").clear
    @driver.find_element(:id, "medico_email").send_keys "admin"
    @driver.find_element(:id, "medico_email").clear
    ...
    @driver.find_element(:xpath, "(//a[contains(text(),'Editar')])[4]").click
    @driver.find_element(:id, "medico_nombre").clear
    @driver.find_element(:id, "medico_nombre").send_keys "Amy"
    @driver.find_element(:id, "medico_apellido1").clear
    @driver.find_element(:id, "medico_apellido1").send_keys "García"
    @driver.find_element(:id, "medico_apellido2").clear
    @driver.find_element(:id, "medico_apellido2").send_keys "Loría"
    @driver.find_element(:name, "commit").click
    (@driver.find_element(:id, "notice").text).should == "Médico fue actualizado exitosamente."
  end
